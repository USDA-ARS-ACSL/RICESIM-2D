!This file contains functions from TTUTIL library from ORYZA
    
    
!obtains one of three values based on the magnitude of the 1st    
...
!    local variables
    ...
    !Table application from ORYZA TTUTIL package
...
!*     initialize
    ...
    ! commented out desired output type for messages
